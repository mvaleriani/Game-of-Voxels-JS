                ...
                <div id="information-modal" className="flex-center" onClick={this.toggleModal} onDoubleClick={(e) => {e.preventDefault()}}>
                    ...
                    <div id="card-stack" style={this.state.display}>

                        {
                            ...
                            <div style={{ position: 'absolute', left: '10px', bottom: 'calc(50% - 22px)', zIndex: 2, transform: 'scaleX(-1)' }} onClick={(e) => this.handleCardIter(e, -1)} onDoubleClick={(e) => { e.stopPropagation() }}>
                                {arrowSVG}
                            </div>
                        }
...

                        {
                            ...
                            <div style={{ position: 'absolute', right: '10px', bottom: 'calc(50% - 22px)', zIndex: 2,  }} onClick={(e) => this.handleCardIter(e, 1)}>
                                { arrowSVG }
                            </div>
                        }
                    </div>
